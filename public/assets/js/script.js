$(window).on("load", function() {
    ...
    $(".post-project > a").on("click", function(){
      ...
      //  ============= POST PROJECT abonnement FUNCTION =========

      $(".post_project_followings").on("click", function(){
        $(".post-popup.pst-pj-followings").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    ...
    $(".post-project-followings > a").on("click", function(){
        $(".post-popup.pst-pj-followings").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });

    
      //  ============= POST PROJECT  abonnés FUNCTION =========

      $(".post_project_followers").on("click", function(){
        $(".post-popup.pst-pj-followers").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    ...
    $(".post-project-followers > a").on("click", function(){
        $(".post-popup.pst-pj-followers").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });
